                    ...
                    <ScrollView>
                        <View style={{ flexDirection: 'column' }}>
                            ...
                            >
                                ...
                                <Text style={{ left: '15px', top: '15px', fontWeight: 'bold', fontSize: '18px' }}>Chia sẻ để đánh giá</Text>

                                <View style={{ width: '330px', left: '15px' }}>
                                    <Text style={{ top: '25px', fontWeight: 'bold', fontSize: '15px', color: 'gray', }}>
                                        Mời mọi người thêm bình luận có dấu thời gian chỉ với 1 cú nhấp.
                                    </Text>
                                </View>

                                <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                                    <Image
                                        source={require("../assets/tb5.png")}
                            ...
                            >
                                ...
                                <View style={{ width: '330px', left: '15px' }}>
                                    ...
                                    <Text style={{ fontWeight: 'bold', fontSize: '18px', top: '1px' }}>Chỉnh sửa dựa trên bản chép</Text>
                                    <Text style={{ fontWeight: 'bold', fontSize: '15px', color: 'gray', top: '10px', right:'5px' }}>
                                        Biến những video có lời nói thành văn bản và dễ dàng điều chỉnh các từ để chỉnh sửa video.
                                    </Text>
                                </View>

                                <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                                    <Image
                                        source={require("../assets/tb6.png")}
