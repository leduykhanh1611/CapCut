                    ...
                    <ScrollView>
                        <View style={{ flexDirection: 'column' }}>
                            ...
                            >
                                ...
                                <Text style={{ left: '15px', top: '15px', fontWeight: 'bold', fontSize: '18px' }}>AutoCut</Text>

                                <View style={{ width: '330px', left: '15px' }}>
                                    <Text style={{ top: '25px', fontWeight: 'bold', fontSize: '15px', color: 'gray', }}>
                                        Thêm tệp đa phương tiện, chờ đợi và để AI biến sản phẩm thô thành video phong cách ngay lập tức.
                                    </Text>
                                </View>

                                <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                                    <Image
                                        source={require("../assets/tb.png")}
                            ...
                            >
                                ...
                                <View style={{ width: '330px', left: '15px' }}>
                                    ...
                                    <Text style={{ fontWeight: 'bold', fontSize: '18px', top: '1px' }}>Xóa nền</Text>
                                    <Text style={{ fontWeight: 'bold', fontSize: '15px', color: 'gray', top: '10px' }}>
                                        Xóa nền hình ảnh hoặc video dễ dàng chỉ với một lần nhấn.
                                    </Text>
                                </View>

                                <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                                    <Image
                                        source={require("../assets/tb2.png")}
